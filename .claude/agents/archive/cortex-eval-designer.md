<!-- # ARCHIVED — superseded by codex-eval-executor.sh (eval-system-refactor spec, 2026-04-10).
     Eval proposal writing remains in cortex-research SKILL Phase 3.
     Eval execution now handled by /cortex-eval-run via codex-eval-executor.sh.
     See: docs/cortex/contracts/eval-system-refactor/contract-001.md -->
---
