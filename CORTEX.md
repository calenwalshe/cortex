...
> into GSD-ready execution contracts via 16 commands and a sequential spine. GSD
...
| `/cortex-parallel` | Create isolated worktree for parallel builds — multiple slugs building concurrently without conflict | Worktree at `.claude/worktrees/{slug}/` |
...
4. **Skill namespace:** All Cortex skills use `/cortex-*` prefix (16 commands total). No collision with `/gsd:*` or any upstream skill namespace.
...
└── docs/                       # Architecture and reference docs
    ...
    ├── COMMANDS.md             # 15-command reference with inputs, outputs, rules
